...
const OurServices = () => {
  return (
    <section className="relative overflow-hidden bg-bgdarkblue text-white w-full  px-4 md:px-8 flex items-center justify-center">
      {/* Left Section: Title */}
      <div className="  w-full  max-w-6xl absolute opacity-25">
        <h2 className=" text-left text-4xl sm:text-6xl md:text-[80px] lg:text-[120px] font-semibold custom-gradient-text font-manrope">Our <br></br>Services</h2>
        </div>
    {/* blurry effect 1 */}
    <div className="absolute transform z-0 -translate-x-1/2  w-[400px] md:w-[866px] h-[300px] md:h-[658px]   bg-white opacity-[3%] rounded-full blur-[80px]"></div>
      ...
      {/* Cards Container */}
      <div className=" w-full relative left-[350px] flex flex-col items-center justify-center gap-8 mt-20 md:mt-0 ">
        {/* Tilted top Card */}
